...
import { Phone, ArrowRight, Video, CheckCircle2, AlertCircle, ChevronDown, ChevronUp } from "lucide-react";
...
export default function VideoMarketing() {
  ...
  return (
    <>
      <SEO
        title="Video Marketing That Gets Watched and Converts | Dekhe Trends"
        description="Videos people actually watch. Not just production — strategy, scripting, and distribution that drives results."
        canonical="https://dekhetrends.com/services/video-marketing"
      />
        ...
        <div className="container px-4 md:px-6 max-w-7xl mx-auto">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-20">
            <h1 className="text-5xl md:text-7xl font-bold mb-6">
              Videos That <span className="gradient-text">Get Results</span>
            </h1>
            <p className="text-xl md:text-2xl text-muted-foreground mb-4 max-w-3xl mx-auto">
              Not just pretty videos — videos that sell
            </p>
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Strategy, scripting, and distribution that turns viewers into customers
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="tel:8077583921">
                <Button size="lg" className="h-14 px-8 text-lg rounded-full bg-gradient-to-r from-primary to-accent">
                  <Phone className="w-5 h-5 mr-2" /> Start Video Strategy
                </Button>
              </a>
              <Link href="/contact">
          ...
          <section className="mb-20">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                "Script writing that hooks viewers",
          ...
          <section className="mb-20">
            ...
            <div className="grid md:grid-cols-4 gap-6">
              {[
                { step: "01", title: "Strategy", desc: "Plan what videos will drive results" },
                { step: "02", title: "Script", desc: "Write hooks that keep viewers watching" },
                { step: "03", title: "Produce", desc: "Create high-quality video content" },
                { step: "04", title: "Distribute", desc: "Get it in front of the right people" }
              ].map((item, i) => (
          ...
          <section className="mb-20">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                "Don't know what videos to make",
                "YouTube channel not growing",
                "Videos look unprofessional",
                "No time to create consistent video content",
                "Competitors dominating video search"
              ].map((problem, i) => (
          ...
          <section className="mb-20">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                { title: "More Reach", desc: "Video gets 3x more reach than text" },
                { title: "Better Trust", desc: "People buy from faces they know" },
                { title: "Higher Conversions", desc: "Video converts better than any other format" }
              ].map((result, i) => (
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="glass-card p-8 rounded-2xl">
                ...
                <ul className="space-y-3 text-lg text-muted-foreground">
                  <li>• Strategy before production</li>
                  <li>• Scripts that hook in 3 seconds</li>
                  <li>• Optimize for each platform</li>
                  <li>• Track views to conversions</li>
                </ul>
              </div>
              <div className="glass-card p-8 rounded-2xl">
                ...
                <ul className="space-y-3 text-lg text-muted-foreground">
                  <li>• Make videos without strategy</li>
                  <li>• Focus only on production quality</li>
                  <li>• Ignore distribution</li>
                  <li>• Chase trends blindly</li>
                </ul>
              </div>
            </div>
          </section>
          ...
          <section className="mb-20">
            ...
            <div className="max-w-3xl mx-auto space-y-4">
              {[
                { q: "Do I need expensive equipment?", a: "No. A good smartphone and proper lighting can produce great results. We focus on strategy and scripting first — production quality matters less than most think." },
                { q: "Which platform should I focus on?", a: "YouTube for long-term SEO. Instagram/Facebook Reels for reach. LinkedIn for B2B. We recommend based on your audience." },
                { q: "How often should I post videos?", a: "Consistency beats frequency. 1-2 quality videos per week beats 5 rushed ones. We build a sustainable schedule." },
                { q: "Can you help with YouTube SEO?", a: "Yes. Titles, descriptions, tags, thumbnails, and watch time optimization. YouTube is the second largest search engine." }
              ].map((faq, i) => (
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="glass-card p-12 rounded-3xl text-center">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">Ready to Start Video Marketing?</h2>
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">Let's create videos that actually grow your business</p>
            <a href="tel:8077583921">
